...
public extension CLLocation {
    ...
    func translation(toLocation location: CLLocation) -> LocationTranslation {
        ...
        let altitudeTranslation = location.altitude - locationManager.location!.altitude
    ...
    func translatedLocation(with translation: LocationTranslation) -> CLLocation {
        ...
        let altitude = locationManager.location!.altitude + translation.altitudeTranslation
